...
from common_line import load_config, resolve_optional_path, write_jsonl_atomic
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Build candidates_20s.jsonl for WIN_YOLO_PTZ_20S")
